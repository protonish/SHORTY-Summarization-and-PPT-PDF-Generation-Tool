...
*/
 ...
 public static int sizef()
  ...
  protected void updatePreview() {
     name = fontNameInputList.getSelected();
    //System.out.println("\nName:"+name);
     size = fontSizeInputList.getSelectedInt();
    //System.out.println("\nsize:"+size);
    if (size <= 0)
      return;
    ...
    previewLabel.setFont(fn);
     ...
     c = (Color) colorComboBox.getSelectedItem();
    //System.out.print(c);
  ...
  public void newf()
  {
    ...
    MainClass dlg = new MainClass(new JFrame());
